2026-07-10 commit — f65759f: Initial kernel extraction — reusable client-agnostic brain shell
   diff: 106 files changed, 23165 insertions(+)
   restricted-paths: true
2026-07-10 commit — a58dd38: Standalone completion — kernel decision trail ported
   diff: 33 files changed, 2386 insertions(+), 36 deletions(-)
   restricted-paths: true
...
2026-07-10 commit — 9a0da54: serve threading+reuse-addr fix (found via test self-diagnosis)
   ...
   restricted-paths: true
2026-07-10 commit — 1998d47: 0.7.0 shipped — hosting profile + instance isolation
...
2026-07-14 merge — PR #25: Graduate the pitch into an epic on the bet
   diff: 6 files, +110/-13
   restricted-paths: false
   by: claude (fable 5)
